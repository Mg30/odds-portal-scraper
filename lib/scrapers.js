async function setOddsFormat(page) {
    ...
    console.log("Setting odds format as EU odds");
    ...
    try {
        ...
        console.error("Odds has not been changed it either due to the odd already on EU mode");
    }
}
...
async function historicScraper(browser, leagueName, startYear, endYear) {
    ...
    try {
        ...
        console.error(`Error scraping historical odds: ${error}`);
        throw error;
    }
